...
| Configure or inspect an MCP server contract | [`mcp-servers/README.md`](../../mcp-servers/README.md) | Keep transport, dynamic tools, credential names, and server safety separate from target selection. |
