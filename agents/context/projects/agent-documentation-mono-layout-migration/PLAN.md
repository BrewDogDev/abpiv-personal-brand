...
| 03 | The integrated migration passes whole-Project review and supplies verified evidence for coordinator archival, promotion, and merge through `preview` to `main`. | 01, 02 | review | task03-implementer | NEEDS_FIXES; second amended re-review pending |
