...
- Revision 01 evidence: commit `10f455dfb65ac94f1a2da156b4e9712242bee1b8` restores the credential-free recovery contract in exactly two Task 04 docs; the original Task 04 reviewer independently verified 20/20 recovery assertions, 189/189 active links, validators, ignore-without-read, safety, scope, and whitespace, then returned amended-head `READY`
