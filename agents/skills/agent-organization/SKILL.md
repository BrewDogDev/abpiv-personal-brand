...
Create narrow learning scopes lazily when the first relevant learning appears. Add `docs/`, `agents/templates/`, deeper skill families, or other support folders only when justified by an active need.
